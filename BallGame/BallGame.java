...
public class BallGame{
	...
	double shelfHeight1 = 50 + Math.random() * 400;
	Ball target1 = new Ball(SHELF_X, shelfHeight1);

	double shelfHeight2 = 50 + Math.random() * 400;
	Ball target2 = new Ball(SHELF_X, shelfHeight2);
	this.drawGameCompletion(this.ball, target1, target2, shelfHeight1, shelfHeight2);
	int count = 0;
