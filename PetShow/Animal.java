...
public class Animal {
    ...
    public void speak(String words) {
        ...
        if (this.direction.equals("right"))
            ...
            boxX +=  this.imageWidth  - 50 - this.wordsWidth;

        UI.eraseRect(boxX, boxY, this.wordsWidth, this.wordsHeight);
        UI.drawRect(boxX, boxY, this.wordsWidth*1.2, this.wordsHeight*1.4);
        UI.drawString(words, boxX + 5, boxY + this.wordsHeight/2 + 3);

        UI.sleep(2000);

        UI.eraseRect(boxX, boxY, this.wordsWidth*1.2, this.wordsHeight*1.6);
    }
