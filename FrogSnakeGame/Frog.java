...
public class Frog {
    ...
    public void move() {
        ...
        if (this.direction .equals("Up")){
         ...
         this.top = Math.max(FrogGame.LEFT_WALL, this.left-SPEED);   
        }
        else if (this.direction .equals("right")){
         this.top = Math.min(FrogGame.RIGHT_WALL-this.size, this.left-SPEED);   
        }
        /*# EDN YOUR CODE HERE */
    ...
    public boolean touching(double x, double y) {
        /*# YOUR CODE HERE */
        return (x>= this.left && x <= (this.left+this.size) && y >= this.top && y <= (this.top+this.size));
        /*# EDN YOUR CODE HERE */
    }
    public  boolean touchingAlternative(double x, double y) {
     if (x < this.left) {
         return false;
        }
