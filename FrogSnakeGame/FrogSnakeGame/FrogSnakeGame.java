 ...
 *  When one of the frogs reaches the bug, the frog eats it and grows in size,
 *       and a new bug appears at a random position within the arena walls.
 *
 *  The game also has two snakes that constantly move in a random direction until
 *    they hit a wall.
...
public class FrogSnakeGame{
     ...
     *  - if any frog was caught by a snake, it shrinks back to its original size.
    ...
    public static void main(String[] arguments){
        FrogSnakeGame fsg = new FrogSnakeGame();
        fsg.setupGUI();
    }   
